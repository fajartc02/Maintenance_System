...
module.exports = {
  getMtbf: (req, res) => {
    ...
    cmdMultipleQuery(
      containerQueryTotalMc.join(";") +
        ";" +
        containerQuerySumProblemMc.join(";") +
        ";" +
        containerQueryCountProblemMc.join(";")
    )
      .then(async (result) => {
        ...
        let mapResult = totalMcsLines.map((arrLine, i) => {
          ...
          let totalProbLine = totalProblemMcs[i].reduce(
            (accumulator, currentValue) => {
          ...
          for (let idx = 0; idx < machinesDataAll.length; idx++) {
            ...
            let obj = {};
            if (
              (typeMttr == 1 && typeMtbf == 1) ||
              (typeMttr == 2 && typeMtbf == 1) ||
              (typeMttr == 1 && typeMtbf == 2)
            ) {
              // RANGED A
              containerA.push(mc);

              let findObj = containerScatters.find(
                (range) => range.name == "Range A"
              );
              if (findObj) findObj.data.push(scatter);
              else
                containerScatters.push({
                  name: "Range A",
                  data: scatter,
                });
            } else if (
              (typeMttr == 1 && typeMtbf == 3) ||
              (typeMttr == 2 && typeMtbf == 2) ||
              (typeMttr == 3 && typeMtbf == 1)
            ) {
              // RANGED B
              containerB.push(mc);
              let findObj = containerScatters.find(
                (range) => range.name == "Range B"
              );
              if (findObj) findObj.data.push(scatter);
              else
                containerScatters.push({
              ...
              (typeMttr == 1 && typeMtbf == 4) ||
              (typeMttr == 2 && typeMtbf == 3) ||
              (typeMttr == 3 && typeMtbf == 2) ||
              (typeMttr == 4 && typeMtbf == 1)
            ) {
              // RANGED C
              containerC.push(mc);
              let findObj = containerScatters.find(
                (range) => range.name == "Range C"
              );
              if (findObj) findObj.data.push(scatter);
              else
                containerScatters.push({
              ...
              (typeMttr == 2 && typeMtbf == 4) ||
              (typeMttr == 3 && typeMtbf == 3) ||
              (typeMttr == 4 && typeMtbf == 2)
            ) {
              // RANGED D
              containerD.push(mc);
              let findObj = containerScatters.find(
                (range) => range.name == "Range D"
              );
              if (findObj) findObj.data.push(scatter);
              else
                containerScatters.push({
              ...
              (typeMttr == 3 && typeMtbf == 4) ||
              (typeMttr == 4 && typeMtbf == 3)
            ) {
              // RANGED E
              containerE.push(mc);
              let findObj = containerScatters.find(
                (range) => range.name == "Range E"
              );
              if (findObj) findObj.data.push(scatter);
              else
                containerScatters.push({
